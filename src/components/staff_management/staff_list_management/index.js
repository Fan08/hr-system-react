 ...
 * @version: 
 * @Author: 唐帆
 * @Date: 2019-12-23 14:22:20
 * @LastEditors: 唐帆
 * @LastEditTime: 2020-04-11 15:45:25
 */
...
import StaffList from './staff_list_management'
import { menu } from "../menu_form"

class StaffListManagement extends Component {
    render() {
        ...
        return (
            <div style={{ height: "100%" }}>
                ...
                <div style={{ width: "69.5%", display: "block-inline", float: "right", backgroundColor: "white", minHeight: "71.5vh" }}>
                    ...
                    <p className={"item"} style={{ marginTop: "1vw" }}>人员管理</p>
                    <StaffList group_inode={selected_inode} />
                </div>
            </div>
        )
    }
...
export default connect(mapStateToProps, null)(StaffListManagement);